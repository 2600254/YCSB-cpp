...
inline void DistinctValueGenerator::init(int numdistint) {
...
inline void DistinctValueGenerator::Next(std::string &value, int len) {
  int k = utils::ThreadLocalRandomInt()%numdistint_;
